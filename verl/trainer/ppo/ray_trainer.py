...
def apply_kl_penalty(data: DataProto, kl_ctrl: core_algos.AdaptiveKLController, kl_penalty="kl"):
    ...
    data.batch["ref_reward_tensor"] = beta * kld
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("reward", timing_raw):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            ...
                            reward_tensor, reward_extra_infos_dict, a_reward_tensor, f_reward_tensor = compute_reward(batch, self.reward_fn)
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        batch.batch["a_reward_tensor"] = a_reward_tensor
                        batch.batch["f_reward_tensor"] = f_reward_tensor
